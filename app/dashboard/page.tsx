...
export default function TrainingDashboardPage() {
  const [moduleForm, setModuleForm] = useState<CreateModuleInput>(createDefaultModuleForm);
                    ...
                    {athleteSchedules.map((week) => (
                      ...
                      >
                        ...
                        <div className="flex flex-col items-end">
                          <span className="badge badge-neutral">Coach: {week.ownerName}</span>
                          <span className="text-xs text-base-content/70">Athlete: {week.athleteName}</span>
                        </div>
                      </li>
                    ))}
                  </ul>
